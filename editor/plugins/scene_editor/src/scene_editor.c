...
scene_editor_plugin_init(
  ...
  ECS_SYSTEM(ecs_ctx, scene_editor_system, EcsOnUpdate, plugin_t, SceneEditorPlugin);
  ECS_SYSTEM(ecs_ctx, scene_editor_scene_system, EcsOnUpdate, threed_camera_t, GuiNodeScene);
